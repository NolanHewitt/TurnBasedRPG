...
function completeLevelUp(){
 if(points === 0){ 
  ...
  if(fileNumber === "1"){
    ...
    expNeeded1= Math.trunc((((2075/2)*lvl1)-1875/2));
    ...
    expNeeded2= Math.trunc((((2075/2)*lvl1)-1875/2));
    ...
    expNeeded3= Math.trunc((((2075/2)*lvl1)-1875/2));
